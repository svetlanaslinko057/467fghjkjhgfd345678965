...
import { Users, Package, ShoppingBag, DollarSign, Plus, BarChart3, Wallet, ClipboardList, TrendingUp, Monitor, Briefcase, Gift, RotateCcw, Shield, Activity, AlertTriangle, Target, FlaskConical, Settings, Headphones } from 'lucide-react';
          ...
          <button
            ...
            className={`px-5 py-3 font-bold rounded-2xl transition-all duration-300 whitespace-nowrap text-sm md:text-base flex items-center gap-2 ${
              activeTab === 'site-settings'
                ? 'bg-gradient-to-r from-slate-600 to-gray-600 text-white shadow-xl scale-105'
                : 'bg-white text-gray-600 hover:bg-gray-50 hover:scale-105 shadow-md'
            }`}
          >
